...
from src.fasttext.model import FastTextModel
...
def main(args):
    ...
    # Save Config
    config = {
        'model_type': 'FastText (EmbeddingBag)',
    ...
    for epoch in range(args.epochs):
        ...
        if f1 > best_f1:
            ...
            with open(os.path.join(args.save_dir, 'metrics.txt'), 'w') as fh:
                fh.write("FastText Model Evaluation\n")
                fh.write(report + "\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default='experiments/fasttext/')
