...
from src.word_embedding.model import WordEmbeddingModel
...
def main(args):
    ...
    # Save Config
    config = {
        'model_type': 'Word Embedding + Average Pooling',
    ...
    print("Starting Word Embedding Average Pooling training")
    best_f1 = 0.0
    ...
    for epoch in range(args.epochs):
        ...
        if f1 > best_f1:
            ...
            with open(os.path.join(args.save_dir, 'metrics.txt'), 'w') as fh:
                fh.write("Word Embedding Average Pooling Evaluation\n")
                fh.write(report + "\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default='experiments/word_embedding/')
